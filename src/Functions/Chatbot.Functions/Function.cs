    ...
    public class Function
    {
        ...
        )
        {
            try
            {
                ...
                var formattedResponse = $"No dia {response.Results.Date} �s {response.Results.Time} a temperatura marca {response.Results.Temp} graus. " +
                                        $"Est� {response.Results.Description.ToLower()}!";
